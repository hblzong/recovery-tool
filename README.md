...
Parse the recovery package that CoinCover provided to you.

The command need four inputs:

1. the file path to the recovery package that CoinCover provided to you
2. the file path to the  private RSA key that CoinCover provided you
3. user passphrase that you set in the App
4. hbc passphrase that HyperBC send you by email
